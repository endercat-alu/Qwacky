    ...
    <Container>
      <Section>
        <SectionHeader>
          ...
          <IconButton onClick={() => setHideUserInfo(!hideUserInfo)}>
        ...
        <>
          ...
          <InfoItem>
            <label className="highlight">Addresses Generated</label>
            <div>
      ...
      <Section>
        <SectionHeader>
          ...
          <IconButton onClick={() => setHideAddresses(!hideAddresses)}>
            ...
            {addresses.map((address, index) => (
              ...
              >
                <span className="address">
                  {address.value}@duck.com
                </span>
                <span className="time">
                  {formatTime(address.timestamp)}
                </span>
              </div>
            ))}
          </AddressList>
